...
public class SO_DynamicState : ScriptableObject
{
    ...
    [InlineEditor] public SO_Enemy_States normalStates;
    [InlineEditor] public SO_Enemy_States ragingStates;
    public EnemyGameplayState gameplayState;
    ...
    {
        normalStates._subStates[subStateIndex].Execute(enemy);
    }
