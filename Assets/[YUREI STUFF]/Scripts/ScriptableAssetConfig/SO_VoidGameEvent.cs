...
public class ParameterGameEventWithKey<T>
{
    ...
    [field: SerializeField] public ScriptableObject ParamData { get; private set; }
    public void Raise()
    {
        GameEvent.Raise(ParamData);
    }
    public void SetValue(T key, SO_ParameterGameEvent gameEvent,ScriptableObject paramData)
    {
        Key = key;
        GameEvent = gameEvent;
        ParamData = paramData;
